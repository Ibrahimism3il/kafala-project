        ...
        <div class="container">
            ...
            <div class="main-edit">
                ...
                <div class="inner-edit container">
                    ...
                    <form action="{{ route('orphan.updateProfile') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="edit-inputs row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="social_status" class="form-control" style="border-radius: 20px">
                                    <option value="">-- اختر الحالة --</option>
                                    <option value="يتيم الأب"
                                        {{ auth()->user()->social_status == 'يتيم الأب' ? 'selected' : '' }}>يتيم الأب
                                    </option>
                                    <option value="يتيم الأبوين"
                                        {{ auth()->user()->social_status == 'يتيم الأبوين' ? 'selected' : '' }}>يتيم
                                        الأبوين</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="health_status" class="form-control" style="border-radius: 20px">
                                    <option value="">-- اختر الحالة --</option>
                                    <option value="سليم"
                                        {{ auth()->user()->health_status == 'سليم' ? 'selected' : '' }}>سليم</option>
                                    <option value="مريض"
                                        {{ auth()->user()->health_status == 'مريض' ? 'selected' : '' }}>مريض</option>
                                </select>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label>الجنس</label>
                                <select name="gender" class="form-control" style="border-radius: 20px">
                                    <option value="">-- اختر الجنس --</option>
                                    <option value="ذكر" {{ auth()->user()->gender == 'ذكر' ? 'selected' : '' }}>ذكر
                                    </option>
                                    <option value="أنثى" {{ auth()->user()->gender == 'أنثى' ? 'selected' : '' }}>
                                        أنثى</option>
                                </select>
                            </div>
                            ...
                            <!-- زر الحفظ -->
                            <div class="col-12">
                                <button class="form-control btn btn-success">حفظ التعديلات</button>
                            </div>
