...
<body>
    ...
    <div class="d-flex all-bage">
        ...
        <div class="container">
            ...
            <form action="{{ route('admin.orphans.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

                <div class="form-container">
                    <div class="title-form">إضافة يتيم جديد</div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="the-sex">
                            <input type="text" name="gender" placeholder="الجنس">
                        </div>
                        <div class="the-aria">
                            <input type="text" name="area" placeholder="المنطقة">
                        </div>
                        <div class="the-health">
                            <select name="health_status" class="select-list-header" required>
                                <option value="">الحالة الصحية</option>
                                <option value="سليم">سليم</option>
                                <option value="مريض">غير سليم</option>
                            </select>
                        </div>
                        <div class="the-social_stauts">
                            <select name="social_status" class="select-list-header" required>
                    ...
                    <div class="file-upload-container">
                        ...
                        <button type="submit" class="add-orphan">إضافة يتيم</button>
                        <a href="{{ route('admin.orphans.index') }}" class="cancle-btn">إلغاء</a>
                    </div>
                </div>
            </form>
