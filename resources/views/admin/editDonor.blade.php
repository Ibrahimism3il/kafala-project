        ...
        <div class="container">
            ...
            <form action="{{ route('admin.donors.update', $donor->id) }}" method="POST">
                ...
                <div class="form-container">
                    <div class="title-form">تعديل معلومات الكافل</div>

                    <div class="form-group">
                        <div class="the-name">
                            <input type="text" name="name"value="{{ $donor->name }}" placeholder="الاسم"
                                required>
                        </div>

                        <div class="the-aria">
                            <input type="text" name="kafel_type" value="{{ $donor->kafel_type }}"
                                placeholder="النوع (فرد/مؤسسة)" required>

                        </div>
                    </div>

                    <div class="file-upload-container">
                        <button type="submit" class="add-orphan">حفظ التعديلات</button>
                        <button type="button" class="cancle-btn" onclick="window.history.back();">إلغاء</button>
                    </div>
                </div>
            </form>
